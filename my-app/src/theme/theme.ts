...
export const theme: Theme = {
  ...
  'drop-shadow-13': "box-shadow: 0px 2.8704702854156494px 3.588087797164917px -2.201871156692505px #16181d19;",
  ...
  'gradient-3': "background-image: linear-gradient(180deg, #faad4f 0%, #dd2a7b 35%, #9537b0 62%, #515bd4 100%);",
  ...
  'gradient-11': "background-image: radial-gradient(circle at 30% 20%, #ffdd55 0%, #ffdd55 10%, #ff543e 50%, #c837ab 100%);",
  'gradient-12': "background-image: radial-gradient(circle at 30% 20%, #3771c8 0%, #3771c8 13%, #6600ff00 100%);",
  'gradient-13': "background-image: linear-gradient(180deg, #0b0b0b00 0%, #000001 100%);",
  'gradient-14': "background-image: linear-gradient(180deg, #c8a47e 24%, #ffffff 49%, #c8a47e 72%);",
  ...
  'gradient-19': "background-image: linear-gradient(180deg, #ff2f2f 0%, #ef7b16 36%, #8a43e1 70%, #d511fd 100%);",
