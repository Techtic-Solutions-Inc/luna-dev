...
/** Home screen tokens (Figma: Home). Background #0e0d0d — use Tailwind spacing, not canvas coords. */
export const homeScreen = {
  name: 'Home',
  background: colors['color-24'],
  foreground: colors.secondary,
  accent: colors.accent,
  accentHover: colors['color-102'],
  mutedForeground: colors['color-14'],
  sectionLightBackground: colors['color-103'],
  ultimateMindBackground: colors['color-93'],
  cardBackground: colors['color-106'],
  inputBackground: colors['color-107'],
  borderSubtle: colors['color-129'],
} as const;
