...
/** Figma export for Group 33654428 — hero dashboard preview (node 2264:10401) */
export const HOME_HERO_DASHBOARD_IMAGE =
  '/assets/figma/group-33654428-2264-10401.png';
...
/** Figma export for Frame 2147227818 (node 2270:14699) — content modal preview source */
...
export const HOME_GROUP_33654450_IMAGE =
  '/assets/figma/group-33654450-3654-11562.png';
