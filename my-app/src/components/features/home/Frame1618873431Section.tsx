...
import { HOME_FRAME_1618873431_IMAGE } from './constants';

/**
 * Frame 1618873431 — Home screen section 9/12 (Figma node 2729:13112).
 * Children: Frame 1618873431 1 (image), Frame 1618873376 (waitlist form).
 */
export function Frame1618873431Section({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      >
        <img
          src={HOME_FRAME_1618873431_IMAGE}
          ...
          <div className="mx-auto flex w-full max-w-[520px] flex-col items-center">
            ...
            >
              ...
              <button
                ...
                className="home-frame-1618873431__submit mx-auto mt-[8px]"
              >
