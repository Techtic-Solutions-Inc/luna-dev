...
export function Footer({ links }: FooterProps) {
  ...
  return (
    <footer className="bg-color-101 px-6 pb-8 pt-16 md:px-10 lg:px-16">
      <div className="mx-auto max-w-content">
        <div className="flex flex-col gap-8 sm:flex-row sm:items-start sm:justify-between">
          <Logo tone="gold" />
          <ul className="flex items-center gap-5 text-white">
            <li>
              <a href="https://facebook.com" aria-label="Facebook" className="transition hover:text-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent" target="_blank" rel="noreferrer">
            ...
            <li>
              <a href="https://x.com" aria-label="X" className="transition hover:text-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent" target="_blank" rel="noreferrer">
                <XIcon />
              </a>
            </li>
            <li>
              <a href="https://linkedin.com" aria-label="LinkedIn" className="transition hover:text-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent" target="_blank" rel="noreferrer">
                <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current" aria-hidden="true">
            ...
            <li>
              <a href="https://instagram.com" aria-label="Instagram" className="transition hover:text-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent" target="_blank" rel="noreferrer">
                <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current" aria-hidden="true">
        ...
        <div className="mt-10 border-t border-white/10 pt-6">
          <div className="flex flex-col gap-4 text-sm text-color-135 md:flex-row md:items-center md:justify-between">
            ...
            <p className="flex items-center gap-2">
              <Link to={terms.href} className="transition hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent">
                {terms.label}
              </Link>
              <span aria-hidden="true">|</span>
              <Link to={privacy.href} className="transition hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent">
                {privacy.label}
              </Link>
            </p>
          </div>
