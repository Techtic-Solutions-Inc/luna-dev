...
function DialogHeader({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div className={cn('flex flex-col gap-gap-6 text-center sm:text-left', className)} {...props} />
  );
}
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn('font-garamond text-xl font-semibold leading-none tracking-tight', className)}
    {...props}
  />
));
