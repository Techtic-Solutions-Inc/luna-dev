...
const variants: Record<Variant, string> = {
  primary:
    "border border-accent bg-accent text-secondary hover:bg-color-102 hover:border-color-102 active:brightness-90 disabled:opacity-50 disabled:cursor-not-allowed",
  secondary:
