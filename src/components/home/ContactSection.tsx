...
const inputClass =
  'w-full rounded-[12px] border border-[#637381] bg-[#11161c] px-[16px] py-[12px] type-body-15 text-ink placeholder:text-[#637381] hover:border-[#c8a47e] focus-visible:border-[#c8a47e] disabled:cursor-not-allowed disabled:opacity-50';
...
export function ContactSection({ data }: ContactSectionProps) {
  ...
  return (
    <section id="contact" className="home-contact-panel bg-[#11161c] px-[20px] py-[113px] md:px-[30px] lg:px-[101px]">
      <div className="mx-auto grid max-w-[1760px] items-stretch gap-[30px] lg:grid-cols-2">
        <div className="relative overflow-hidden rounded-[24px]">
          ...
          />
          <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center bg-[#000001]/30 px-[24px] text-center">
        ...
        <div className="rounded-[24px] border border-[#637381] bg-[#1d1a1a] px-[24px] py-[30px] md:px-[30px]">
          <div className="mx-auto flex h-[72px] w-[72px] items-center justify-center rounded-[100px] border border-[#c8a47e]">
            <span className="font-kalam text-[32px] text-[#c8a47e]">a</span>
          </div>
          <h2 className="text-center font-garamond text-[32px] font-medium leading-[1.2] text-ink md:text-[40px]">
            Let’s Work Together
          </h2>
          {email ? <p className="type-body-29 mt-[10px] text-center text-[#637381]">{email}</p> : null}
          {phone ? <p className="type-body-15 mt-[10px] text-center text-[#637381]">{phone}</p> : null}
          {status ? (
            <p className="type-body-16 mt-[24px] text-center text-[#637381]" role="status">
              {status}
            </p>
          ) : null}
