...
export function EmptyLinksState({
  ...
  return (
    <div className="mx-auto w-full max-w-[800px] rounded-[16px] border border-[#637381] bg-[#11161c] px-[20px] py-[24px] text-center">
      <h2 className="font-garamond text-[28px] font-medium text-ink">{title}</h2>
      <p className="type-body-33 mt-[10px] text-[#637381]">{description}</p>
    </div>
  );
}
