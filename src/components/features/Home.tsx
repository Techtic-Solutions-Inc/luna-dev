...
export function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-[#11161c] px-[20px] text-white">
      ...
      <p className="type-body-15 mt-[16px] text-[#637381]">Real estate marketing for agents.</p>
      <nav className="mt-[30px] flex gap-[24px]" aria-label="Account">
        <Link to="/signin" className="type-body-115 text-[#c8a47e] hover:underline">
          Sign in
        </Link>
        <Link to="/signup" className="type-body-115 text-[#c8a47e] hover:underline">
          Sign up
        </Link>
      </nav>
    </main>
