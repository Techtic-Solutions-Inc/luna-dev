...
export const layerBlur = {
  'layer-blur-2': '394px',
  'layer-blur-3': '514px',
  'layer-blur-4': '276.1745910644531px',
  'layer-blur-6': '211.69802856445312px',
  'layer-blur-7': '191.4674072265625px',
  'layer-blur-8': '121.02381896972656px',
  'layer-blur-9': '157.8838653564453px',
  'layer-blur-12': '320px',
  'layer-blur-16': '94px',
  'layer-blur-21': '339.35546875px',
  'layer-blur-23': '224px',
  'layer-blur-31': '28.584068298339844px',
  'layer-blur-36': '1954.410888671875px',
  'layer-blur-38': '50px',
} as const;

export const backgroundBlur = {
  'background-blur-10': '15px',
  'background-blur-20': '6.458558082580566px',
  'background-blur-22': '4px',
  'background-blur-25': '1.9444444179534912px',
  'background-blur-32': '7.176175594329834px',
} as const;
