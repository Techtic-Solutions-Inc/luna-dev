...
export const shadows = {
  ...
  'drop-shadow-12': '-1.44px 0 12.02px #00000019',
  'drop-shadow-14': '0 2.87px 3.59px -2.2px #16181d19',
  'drop-shadow-15': '0 0 7.18px -1.65px #16181d19',
  'drop-shadow-16': '-1.46px 0 12.15px #00000019',
  'drop-shadow-18': '0 44px 54px #3b3b3b72',
  'drop-shadow-19': '10px 10px 20px #0000007f',
  'drop-shadow-20': '0 34px 44px #00000072',
  'drop-shadow-22': '-1.4px 0 11.7px #00000019',
  'drop-shadow-23': '0 1.87px 18.72px #00000019',
  'drop-shadow-27': '0 1.87px 18.67px #00000019',
  'drop-shadow-29': '0 1.94px 1.94px #0000003f',
  'drop-shadow-30': '-10px -20px 34px #000000f2',
  'drop-shadow-31': '0 0 2px #ffffff14',
  'drop-shadow-32': '-1.72px 0 14.3px #00000019',
