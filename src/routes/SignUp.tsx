...
const pageTokens = {
  '--su-accent': COLOR_ACCENT,
  '--su-muted': COLOR_MUTED,
  '--su-error': COLOR_ERROR,
  '--su-ink': COLOR_INK,
  '--su-bronze': COLOR_BRONZE,
  '--su-surface': COLOR_SURFACE,
    ...
    <main className="flex min-h-screen w-full bg-[#000001] text-[#ffffff]" style={pageTokens}>
      <section className="relative flex min-h-screen w-full min-w-0 flex-col items-center justify-center overflow-hidden border-none px-[24px] py-[40px] desktop:flex-[781] desktop:items-center desktop:px-[40px]">
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 70% 55% at 52% 38%, rgba(200, 164, 126, 0.32) 0%, rgba(139, 104, 66, 0.22) 40%, transparent 72%)',
          }}
          aria-hidden="true"
        />
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 48% 40% at 6% 94%, rgba(52, 168, 83, 0.16) 0%, rgba(139, 104, 66, 0.18) 42%, transparent 70%)',
          }}
          aria-hidden="true"
        />
        <div
          ...
          style={{
            background:
              'linear-gradient(180deg, rgba(0, 0, 1, 0.15) 0%, rgba(17, 22, 28, 0.35) 100%)',
          }}
          aria-hidden="true"
        />
        <div
          className="relative z-[1] flex w-full max-w-[461px] flex-col items-center gap-[24px]"
