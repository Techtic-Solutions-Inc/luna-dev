  ...
  return (
    <div className="min-h-screen bg-page" aria-busy="true" aria-live="polite">
      <div className="mx-auto max-w-content px-6 py-6">
        <div className="h-10 w-40 animate-pulse rounded-12 bg-white/10" />
      </div>
...
export function HomePage() {
  ...
  return (
    <div className="bg-page text-white">
      <div className="hero-glows bg-grid">
        <Header links={links} />
        ...
        <section className="relative overflow-hidden" aria-labelledby="hero-heading">
          <div className="mx-auto grid max-w-content items-center gap-12 px-6 pb-8 pt-8 md:px-10 lg:grid-cols-[minmax(0,0.46fr)_minmax(0,0.54fr)] lg:gap-8 lg:px-16 lg:pt-6">
            <div>
              <h1
                id="hero-heading"
                className="max-w-xl font-serif text-[42px] font-medium leading-[1.08] text-white sm:text-5xl lg:text-page-title"
              >
            ...
            <div className="relative">
              <img
                ...
                className="relative z-10 w-full rounded-24 object-contain object-right drop-shadow-2xl"
              />
            </div>
          </div>
          ...
          <div className="mx-auto flex max-w-content flex-col items-center px-6 pb-16 pt-4 text-center md:pb-20">
            <p className="font-sans text-lg text-white md:text-xl">
              ...
              <span className="text-accent">
                {headingOf(headings, 'Hundreds', 'Hundreds')}
              </span>{' '}
              of other agents on the waitlist for Agentwise
            </p>
            <Link to={getStarted.href} className="btn-gold mt-6 min-w-[200px] px-10 py-3.5">
              {getStarted.label}
            </Link>
          </div>
        </section>
      ...
      <ImageGallery heading={galleryHeading} subheading={gallerySub} images={images} />
      ...
      <section id="learn-more" className="bg-grid bg-color-105 px-4 py-16 md:px-10 md:py-24" aria-labelledby="deal-heading">
        <div className="mx-auto grid max-w-content overflow-hidden rounded-[40px] bg-forest-deep md:grid-cols-2">
          <div className="bg-forest-card px-8 py-12 md:px-12 md:py-16">
            <h2 id="ultimate-mind-heading" className="font-serif text-4xl text-white md:text-5xl">
              Agentwise Ultimate Mind
            </h2>
            <p className="mt-6 max-w-lg font-sans text-step-desc text-[#d8d8d8]">
            ...
            <img
              ...
              className="mt-10 w-full rounded-24 object-cover object-top shadow-deep"
            />
          </div>
          <div className="flex flex-col justify-center bg-forest-deep px-8 py-12 md:px-12 md:py-16">
            ...
            <p className="mt-8 max-w-md font-sans text-step-desc text-[#d8d8d8]">{dealBody}</p>
            <Link to={learnMore.href} className="btn-gold mt-10 w-fit px-8 text-white">
              {learnMore.label}
            </Link>
          </div>
        </div>
      ...
      <section id="about" className="bg-white py-20 md:py-28" aria-labelledby="testimonials-heading">
        <div className="mx-auto grid max-w-content gap-12 px-6 md:grid-cols-[minmax(0,0.38fr)_minmax(0,0.62fr)] md:items-start md:px-10 lg:px-16">
          <div className="md:sticky md:top-16">
            <h2 id="testimonials-heading" className="font-serif text-4xl leading-tight text-color-101 md:text-5xl lg:text-[56px]">
              Built For
        ...
        <div className="mx-auto grid max-w-content gap-5 lg:grid-cols-2">
          <div className="relative min-h-[520px] overflow-hidden rounded-24">
            <img
              ...
              alt="Agent on a call — everyone’s waiting to buy until the market is right"
              className="absolute inset-0 h-full w-full object-cover"
            />
          </div>
          <div className="rounded-24 border border-white/10 bg-gradient-to-b from-color-106 to-color-105 px-6 py-10 shadow-hairline md:px-12 md:py-14">
            <div className="mx-auto mb-6 flex h-14 w-14 items-center justify-center rounded-full border border-white/40 font-script text-2xl text-white">
              a
            </div>
