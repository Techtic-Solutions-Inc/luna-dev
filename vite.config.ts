...
const LUNA_FIGMA_MOCKUP_SNIPPETS = [
  ...
  '<img src="/assets/figma/I3917-8120;1237-2083.png" alt="Dashboard/Nav/Vertical/Item" className="w-full h-auto" />',
  ...
  '<img src="/assets/figma/2295-3482.png" alt="Group 8" className="w-full h-auto" />',
] as const;
