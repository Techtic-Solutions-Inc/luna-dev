...
export function ForgotPasswordForm() {
  ...
  return (
    <form className="forgot-password-form" onSubmit={handleSubmit} noValidate>
      ...
      <div className="forgot-password-form__divider" aria-hidden="true" />

      <p className="forgot-password-form__footer">
        {isSuccess ? 'Ready to sign in?' : 'Remembered your password?'}{' '}
        <Link className="forgot-password-form__sign-in-link" to="/signin">
          Sign in
        </Link>
      </p>
    </form>
