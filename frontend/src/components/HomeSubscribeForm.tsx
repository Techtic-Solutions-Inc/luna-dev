...
const EXPERIENCE_OPTIONS = [
  { value: '', label: 'How long have you been in real estate?' },
...
const MARKETING_OPTIONS = [
  { value: '', label: 'What is your current monthly marketing budget?' },
    ...
    <form className="home-subscribe-form" onSubmit={handleSubmit} noValidate>
      ...
      >
        ...
        <select
          ...
          aria-label="What is your current monthly marketing budget?"
          required
        >
