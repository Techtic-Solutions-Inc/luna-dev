...
export function BrainIcon(props: IconProps) {
  return (
    <Base {...props}>
      <path d="M8 4.5a2.5 2.5 0 0 0-2.5 2.5v1A2.5 2.5 0 0 0 8 10.5" />
      <path d="M16 4.5a2.5 2.5 0 0 1 2.5 2.5v1A2.5 2.5 0 0 1 16 10.5" />
      <path d="M8 10.5a2.5 2.5 0 0 0-2.5 2.5V14a3.5 3.5 0 0 0 3.5 3.5h1" />
      <path d="M16 10.5a2.5 2.5 0 0 1 2.5 2.5V14a3.5 3.5 0 0 1-3.5 3.5h-1" />
      <path d="M10 18v2M14 18v2" />
    </Base>
  );
}

export function ListSparkIcon(props: IconProps) {
  return (
    <Base {...props}>
